    ...
    if (onoff == 1) {
        if (Position >= striplaenge * 0.8) {
            basic.showLeds(`
                ...
                # . . . .
                `)
        } else if (Position >= striplaenge * 0.6) {
            basic.showLeds(`
                . . . . .
                . # . . .
                . # . . .
                ...
                . . . . .
                `)
        } else if (Position >= striplaenge * 0.4) {
            basic.showLeds(`
                . . . . .
                . . . . .
                . . # . .
                ...
                . . . . .
                `)
        } else if (Position >= striplaenge * 0.2) {
            basic.showLeds(`
                . . . . .
                . . . # .
                . . . # .
...
let striplaenge = 0
striplaenge = 60
let strip = neopixel.create(DigitalPin.P2, striplaenge, NeoPixelMode.RGB)
...
basic.forever(function () {
    strip.clear()
    Position += 1 * Math.map(input.acceleration(Dimension.X), 0, 1023, 0, -6)
